import{f as e}from"./math.scalar.functions-Tru935qk.js";import{t}from"./shaderStore-Dw977DTa.js";var n=e({lodCubePixelShader:()=>a}),r=`lodCubePixelShader`,i=`precision highp float;const float GammaEncodePowerApprox=1.0/2.2;varying vec2 vUV;uniform samplerCube textureSampler;uniform float lod;uniform int gamma;void main(void)
{vec2 uv=vUV*2.0-1.0;
#ifdef POSITIVEX
